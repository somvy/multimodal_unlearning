...
with open(f'vtofu_metadata/labels.pickle', 'wb') as file:
...
with open(f'vtofu_metadata/forget_01.pickle', 'wb') as file:
    pickle.dump(forget_01_inds, file)
    
with open(f'vtofu_metadata/forget_05.pickle', 'wb') as file:
    pickle.dump(forget_05_inds, file)

with open(f'vtofu_metadata/forget_10.pickle', 'wb') as file:
    pickle.dump(forget_10_inds, file)
    
with open(f'vtofu_metadata/holdout_01.pickle', 'wb') as file:
    pickle.dump(holdout_01_inds, file)
    
with open(f'vtofu_metadata/holdout_05.pickle', 'wb') as file:
    pickle.dump(holdout_05_inds, file)

with open(f'vtofu_metadata/holdout_10.pickle', 'wb') as file:
