...
if __name__ == "__main__":
    ...
    os.makedirs(f"./checkpoints/finetune/forget_size={args.forget_size}", exist_ok=True)
    torch.save(state, f"./checkpoints/finetune/forget_size={args.forget_size}/{args.net}_{args.split_idx:03}.pth")
