...
if __name__ == '__main__':
    ...
    # Build model
    checkpoint = torch.load(f'./checkpoints/pretrained/resnet18.pth')
    ...
    os.makedirs(f'checkpoints/retrain/forget_size={args.forget_size}/', exist_ok=True)
    torch.save(state, f'checkpoints/retrain/forget_size={args.forget_size}/resnet18_{args.split_idx:03}.pth')
